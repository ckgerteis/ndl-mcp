...
Download `ndl-mcp-1.2.1.mcpb` from the [latest release](https://github.com/ckgerteis/ndl-mcp/releases/latest) and open it; Claude Desktop installs it. One bundle serves Windows, macOS (Apple Silicon and Intel) and Linux. Claude Desktop asks only for a receipts folder at install time.
...
uvx --from "git+https://github.com/ckgerteis/ndl-mcp@v1.2.1" ndl-mcp
```
