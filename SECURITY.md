...
The latest release on the [releases page](https://github.com/ckgerteis/ndl-mcp/releases) is
...
or email christopher.gerteis@gmail.com with "ndl-mcp security" in the subject. Say which version, how to reproduce, and
